...
function creatureSayCallback(cid, type, msg)
  ...
  local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
  if msgcontains(msg, "minotaur leather") and getPlayerStorageValue(cid, fcitizen) == -1 then
  ...
  elseif msgcontains(msg, "backpack") and getPlayerStorageValue(cid, fcitizen) < 1 then
    ...
    Topic[talkUser] = 5
  elseif msgcontains(msg, "yes") and getPlayerStorageValue(cid, fcitizen) < 1 and Topic[talkUser] == 5 and getPlayerItemCount(cid, 5878) >= 100 then
