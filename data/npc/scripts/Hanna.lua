...
node1 = keywordHandler:addKeyword({'hat'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To get citizen feather hat you need give me 100 chicken feathers, 50 honeycombs and a legion helmet. Do you have them with you?'})
